...
public class MainDip {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("4. Envoyer un Pigeon voyageur");
            ...
            if (selectedSender != null) {
                ...
                NotificationService service = new NotificationService(selectedSender);
